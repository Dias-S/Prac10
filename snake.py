...
if row:
    score = int(row[0])
    level = (score // 10) + 1
    print(f"Добро пожаловать, {player_name}! Ваш текущий счёт: {score}, уровень: {level}\n\n")
...
def pause_game():
    ...
    while paused:
        ...
        screen.blit(pause_text, (width // 2 - 50, height // 2 - 100))

        mouse = pygame.mouse.get_pos()
        click = pygame.mouse.get_pressed()

        if 150 <= mouse[0] <= 350 and 250 <= mouse[1] <= 290:
            pygame.draw.rect(screen, (100, 200, 100), (150, 250, 200, 40))
        else:
            pygame.draw.rect(screen, (0, 150, 0), (150, 250, 200, 40))
        cont_text = button_font.render("Continue", True, (255, 255, 255))
        screen.blit(cont_text, (190, 255))

        if 150 <= mouse[0] <= 350 and 310 <= mouse[1] <= 350:
            pygame.draw.rect(screen, (200, 100, 100), (150, 310, 200, 40))
        else:
            pygame.draw.rect(screen, (150, 0, 0), (150, 310, 200, 40))
        quit_text = button_font.render("Quit", True, (255, 255, 255))
        screen.blit(quit_text, (215, 315))
...
while Running:
    ...
    for block in snake_body[1:]:
        if snake_pos[0] == block[0] and snake_pos[1] == block[1]:
            ...
            if snake_pos[0] == 10 or snake_pos[0] == 480 or snake_pos[1] == 10 or snake_pos[1] == 480:
                Running = False
                game_over_screen()
